...
object TaskNotificationHelper {
    ...
    fun showProgressNotification(context: Context, title: String, text: String) {
        val notification = buildProgressNotification(context, title, text)
    ...
    /**
     * Build a foreground notification for long-running WorkManager tasks.
     */
    fun buildForegroundInfo(context: Context, title: String, text: String): ForegroundInfo {
        val notification = buildProgressNotification(context, title, text)
    ...
    private fun buildProgressNotification(context: Context, title: String, text: String): Notification {
